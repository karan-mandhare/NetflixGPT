  ...
  return (
    <div>
      ...
      <form
        ...
        className="absolute md:p-12 p-6 bg-black md:w-4/12 w-4/5 mx-auto md:my-32 my-24 right-0 left-0 bg-opacity-80 text-white"
      >
        ...
        <p onClick={toggleSignupForm} className="py-4 md:px-0 px-4 cursor-pointer">
          {isSignInForm
